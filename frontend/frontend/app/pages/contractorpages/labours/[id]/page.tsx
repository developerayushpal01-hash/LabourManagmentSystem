...
type Labour = { _id: string; labourCode: string; name: string; mobile: string; gender: string; address?: string; dailyWage?: number | null; finalDailyWage: number; status: string; skillId: { skillName: string } | null; site: Site | null; createdAt: string }
