...
export type Salary = { labourId: string; name: string; mobile: string; presentDays: number; halfDays: number; absentDays: number; holidayDays: number; overtimeHours: number; grossSalary: number; netSalary: number; ctc: number; paidAmount: number; balanceAmount: number; pfWage: number; pfEmployee: number; pfEmployer: number; esicWage?: number; esicEmployee: number; esicEmployer: number; status: string }
