...
type Labour = { _id:string; companyId?:{companyName?:string;companyCode?:string;logoUrl?:string|null}|null; labourCode:string; qrCode?:string|null; photoUrl?:string|null; name:string; mobile:string; gender:string; dob?:string|null; address?:string; department?:string|null; aadhaarNumber?:string|null; panNumber?:string|null; bankAccountNumber?:string|null; ifscCode?:string|null; emergencyContact?:{name?:string;relation?:string;mobile?:string}; joiningDate?:string|null; resignationDate?:string|null; dailyWage?:number|null; finalDailyWage:number; isPFApplicable?:boolean; pfUanNumber?:string|null; isESICApplicable?:boolean; esicIpNumber?:string|null; status:string; skillId:{skillName:string}|null; site:Site|null; createdAt:string }
