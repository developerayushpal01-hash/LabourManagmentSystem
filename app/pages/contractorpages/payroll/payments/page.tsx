...
export default function PaymentEntryPage() {
  ...
  if (loading) return <PageLoader label="Loading payment data" fullScreen />
      ...
      <div className="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
        <form onSubmit={submit} className="space-y-5">
          ...
          {type === "SALARY" && labourId && <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
            ...
            {previewLoading ? <PageLoader label="Calculating complete salary" compact /> : salaryDetails ? <div className="p-5">
