...
const Icon = ({ name }: { name: string }) => {
  switch (name) {
    case "dashboard":
      return (
        <Image src="/assets/dashboard.png" alt="Dashboard" width={20} height={20} className="h-5 w-5 object-contain" />
      )
    case "users":
      return (
        <Image src="/assets/users.png" alt="Users" width={22} height={16} className="h-5 w-5 object-contain" />
      )
    case "labours":
      return (
        <Image src="/assets/labours.png" alt="Labours" width={20} height={19} className="h-5 w-5 object-contain" />
      )
    case "skills":
      return (
    ...
    case "sites":
      return (
        <Image src="/assets/sites.png" alt="Sites" width={16} height={20} className="h-5 w-5 object-contain" />
      )
    case "attendance":
      return (
        <Image src="/assets/attendance.png" alt="Attendance" width={18} height={20} className="h-5 w-5 object-contain" />
      )
    case "salary":
    case "payroll":
      return (
        <Image src="/assets/payroll.png" alt="Payroll" width={22} height={16} className="h-5 w-5 object-contain" />
      )
    case "invoices":
      return (
        <Image src="/assets/reports.png" alt="Invoices" width={20} height={20} className="h-5 w-5 object-contain" />
      )
    case "advance":
      return (
        <Image src="/assets/advance.png" alt="Advance" width={22} height={16} className="h-5 w-5 object-contain" />
      )
    case "reports":
      return (
        <Image src="/assets/reports.png" alt="Reports" width={20} height={20} className="h-5 w-5 object-contain" />
      )
    case "profile":
      return (
        <Image src="/assets/profile.png" alt="Profile" width={20} height={20} className="h-5 w-5 object-contain" />
      )
    case "payroll-settings":
    case "settings":
      return (
        <Image src="/assets/setting.png" alt="Settings" width={21} height={20} className="h-5 w-5 object-contain" />
      )
    default:
      return null
  }
      ...
      <div className="px-6 py-6">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-indigo-50 rounded flex items-center justify-center">
            <Image src="/assets/logo.png" alt="Logo" width={42} height={28} className="h-auto w-7 object-contain" />
          </div>
          <div>
